export default class MailchimpForm {
    ...
    startLoading() {
        const loadingIcon = '<div class="inline-block" role="status">'
            + '<svg aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">'
