export default class MadeForm {
    ...
    constructor(form) {
        ...
        this._form.querySelectorAll("input, textarea").forEach((input) => {
    ...
    processInputError(input, error) {
        const descriptionElement = this._form.querySelector(
        ...
        switch (error) {
            ...
            case "validation.required_if":
                errorElement.innerText =
                    "Je bent dit veld vergeten in te vullen.";
                break;
            case "email":
            ...
            case "numeric":
                errorElement.innerText =
                    "Hier moet een numeriek getal ingevuld worden.";
                break;
            case "string":
            ...
            case "validation.max.string":
                errorElement.innerText =
                    "Deze tekst is te lang. Maximaal kun je maar 255 karakters gebruiken.";
                break;
            case "validation.min.string":
                errorElement.innerText =
                    "Deze tekst is te kort. Het moet minimaal uit 10 karakters bestaan.";
                break;
